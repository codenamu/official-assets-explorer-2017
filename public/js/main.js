...
function getAssetDataHtml(tengible_estate_assets, tengible_assets, financial_assets, political_assets, liability_assets){
    ...
    if(0< tengible_estate_assets.length){
        for(var i=0; i<tengible_estate_assets.length;i++){
            ...
            present_price += tengible_estate_assets[i].present_price;
        }
    ...
    if(0< political_assets.length){
        for(var i=0; i<political_assets.length;i++){
            ...
            present_price += political_assets[i].present_price;
        }
...
function getAssetDataHtmlByMobile(tengible_estate_assets, tengible_assets, financial_assets, political_assets, liability_assets){
    var year = 2017;
    var previous_price = 0;
    var present_price = 0;
    var row = ""
